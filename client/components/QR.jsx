    ...
    <>
      <div>
        <div>
          ...
          <p>To know the minimum sizes based on the distance, we used the following formula:</p>
          <p>Size of your QR Code = Distance between the QR Code and the Scanner ÷ 10</p>
          <p>Example : A 33 cm QR square would be ideal to read at approximately 3m away</p>
        </div>
