...
const PayBusker = () => {
  ...
  // TODO: I suspect you should have `id` and `dbPublicUser` in your dependencies array
  useEffect(() => {
    if (dbPublicUser) {
        ...
        <Container maxW={'3xl'}>
          <Box textAlign={'center'} py={36}>
            ...
            <Stack
              ...
              alignSelf={'center'}
            >
              {/* TODO: hard coding any number of options is a bit of a red flag https://en.wikipedia.org/wiki/Zero_one_infinity_rule */}
